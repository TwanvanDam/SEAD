...
class Coeff:
    ...
    def x_ac(self,wing_contribution_c, C_L_alpha_Ah, k_n=-2.5):
        ...
        # print(wing_contribution_c, fuselage_contribution1_c + fuselage_contribution2_c, nacelles_contribution_c,
        #       wing_contribution_c + fuselage_contribution1_c + fuselage_contribution2_c + nacelles_contribution_c)
